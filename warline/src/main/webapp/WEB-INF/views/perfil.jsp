...
<!-- script>
	var statsHeroe = ${estadisticasHeroe};
				...
				<div id = "estadisticas">
					...
					<form method = POST action = "subirStats">
						<table>
							...
							<tr>  <td> Experiencia </td><td> <c:out value="${user.heroe.xp}"/> </td>  </tr>
							<tr>  <td> Puntos de Habilidad: </td><td> <c:out value="${user.heroe.puntosHab}"/> </td>  </tr>
						</table>
					</form> 
					</div>
				</div>
