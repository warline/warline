...
insert into Item values(1, 50, 10, 20, 'Armadura de Elfo Oscuro', 200, 5, 2, 5, 100);
insert into Item values(2, 40, 10, 20, 'Armadura elfica', 200, 5, 2, 15, 100);
insert into Item values(3, 30, 5, 1, 'Casco de justas', 80, 5, 0, 5, 50);
insert into Item values(4, 25, 5, 20, 'Casco elfico', 80, 5, 0, 15, 50);
insert into Item values(5, 50, 0, 5, 'Escudo del aguila', 50, 5, 3, 5, 100);
insert into Item values(6, 0, 70, 15, 'Gran mandoble', 150, 5, 1, 10, 30);
insert into Item values(7, 0, 80, 15, 'Maza dentada', 150, 5, 1, 15, 30);
insert into Item values(8, 45, 0, 1, 'Escudo redondo', 50, 5, 3, 10, 65);
