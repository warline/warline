...
insert into Item values(1, 20, 20, 10, 'Armadura de Elfo Oscuro', 100, 5, 2, 5, 50);
insert into Item values(2, 20, 20, 10, 'Armadura elfica', 100, 5, 2, 5, 50);
insert into Item values(3, 20, 20, 10, 'Casco de justas', 100, 5, 2, 5, 50);
insert into Item values(4, 20, 20, 10, 'Casco elfico', 100, 5, 2, 5, 50);
insert into Item values(5, 20, 20, 10, 'Escudo del aguila', 100, 5, 2, 5, 50);
insert into Item values(6, 20, 20, 10, 'Gran mandoble', 100, 5, 2, 5, 50);
insert into Item values(7, 20, 20, 10, 'Maza dentada', 100, 5, 2, 5, 50);
